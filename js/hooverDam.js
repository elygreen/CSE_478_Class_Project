...
d3.csv("datasets/lakeMeadStorage.csv").then(data => {
    console.log("Lake Mead data loaded:", data.length, "rows");
    ...
    // Add gradient (different colors for Lake Mead)
    const gradient = svg.append("defs")
        .append("linearGradient")
        .attr("id", "mead-gradient")
        .attr("x1", "0%")
        .attr("x2", "0%")
        .attr("y1", "0%")
        .attr("y2", "100%");
    ...
    console.error("Error loading Lake Mead data:", error);
    d3.select("#hoover-dam-chart")
        .append("div")
        .style("padding", "20px")
        .style("color", "red")
